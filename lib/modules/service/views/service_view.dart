import 'package:fastery/modules/service/views/widgets/services_grid.dart';
...
class ServiceView extends GetView<ServiceController> {
  ...
  // Re-used Service Grid Item
  Widget _buildServiceItem(ServiceModel service) {
    // ... (Your existing _buildServiceItem implementation)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 💡 Key Change: Use NestedScrollView for the collapsible effect
      body: CustomScrollView(
        slivers: <Widget>[
          // 1. SliverAppBar (The Collapsible Header)
          SliverAppBar(
            pinned: true, // Keeps the small header visible when scrolled
            expandedHeight: 410.0, // Height of the expanded banner
                ...
                return SliverToBoxAdapter(
                  child: Center(
                    child: Padding(
                      ...
                      child: const CircularProgressIndicator(color: AppColors.primaryRed),
                    ),
                  ),
                );
              }
